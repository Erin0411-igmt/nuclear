...
csv_path = os.path.join(BASE_DIR, 'nuclear_explosions.csv')
df_nuclear = pd.read_csv(csv_path)
#df_nuclear = pd.read_csv("C:\\Users\\eacou\\OneDrive - Bentley University\\CS 230\\Final Project\\nuclear_explosions.csv")
#python -m streamlit run "C:\Users\eacou\OneDrive - Bentley University\CS 230\Final Project\streamlit.py"
...
page_select = st.sidebar.radio("Go to", ["Yield and Method Across Decades", "Deployment Locations", "Deployment Purpose"])
st.sidebar.markdown("-----")
